  ...
  return (
    <section className={styles.bgSub}>
      <div className=' text-white text-center '>
        ...
        <p className="text-xs lg:text-base mt-3 lg:mt-6">Subscribe here to get healthy tips on how to stay fit, live your best life.</p>
      </div>
      
      <div className={styles.formContainer}>
        <form action="https://fabform.io/f/gJvvnB-" method="post" className=" p-3 lg:p-4 lg:flex justify-center">
